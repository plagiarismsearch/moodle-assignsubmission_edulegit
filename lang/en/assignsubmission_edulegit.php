...
$string['pluginabout'] = '<a href="https://edulegit.com/">EduLegit.com</a> is AI management control system, teacher assistant and student supervision';
...
$string['privacy:metadata:assignsubmission:taskuserid'] = 'The unique identifier of the user associated with the EduLegit submission task.';
...
$string['ws_token_help'] = 'This token is used to authenticate external webhook requests for the plugin. <br>You can generate it by navigating to <em>Site administration > Server > Web services > Manage tokens > Add</em>.';
